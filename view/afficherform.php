...
$listeFormations = $formationManager->afficher($pdo);
                    ...
                    <?php foreach ($listeFormations as $formation) : ?>
                        <div class="crud__table-row">
                            ...
                            <button onclick="deletef(<?= $formation['id']; ?>)">Supprimer</button>
                                ...
                                <button class="btn btn-primary" onclick="window.location.href='filtrer_formations_par_type.php?id=<?= $formation['id']; ?>'">filtrer</button>
