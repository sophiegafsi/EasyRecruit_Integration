<?php
require_once 'C:/xampp/htdocs/Nourprojet/controller/exam.php'; // Importez la classe Examen si nécessaire
require_once 'C:/xampp/htdocs/Nourprojet/cnx.php';

// Récupérez la liste des examens
$examenManager = new Exam(); // Assurez-vous d'instancier la classe ExamenManager si nécessaire
$listeExamens = $examenManager->afficher($pdo);
$total= $examenManager->countExamens($pdo)// Assurez-vous d'avoir une méthode pour récupérer la liste des examens

// Affichez les examens
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <nav class="navbar">
                ...
                <div class="navbar__left">
                    ...
                    <a class="active_link" href="http://localhost/Nourprojet/views/ajouterform.php">Admin</a>
                    <a href="http://localhost/Nourprojet/views/afficherform.php">Formation</a>
                </div>
            ...
            <div class="main__container">
                ...
                <div class="main__cards">
                    ...
                    <div class="card">
                        ...
                        <div class="card_inner">
                            <p class="text-primary-p">Number of exams</p>
                ...
                <div class="crud__table-container">
                    <div class="crud__table">
                        <div class="crud__table-header">
                            ...
                            <div>Date de l'examen</div>
                            <div>Actions</div>
                        </div>
                        <?php foreach ($listeExamens as $examen) : ?>
                            <div class="crud__table-row">
                                <div data-label="#"><?= $examen['id']; ?></div>
                                <div data-label="Nom"><?= $examen['nom']; ?></div>
                                <div data-label="Date"><?= $examen['date']; ?></div>
                                <div data-label="Actions">
                                <button onclick="deleteExamen(<?= $examen['id']; ?>)">Supprimer</button>
                                <button class="btn btn-primary" onclick="window.location.href='updateexam.php?id=<?php echo $examen['id']; ?>'">Modifier</button>
                                <button class="btn btn-primary" onclick="window.location.href='afficherexamprecis.php?id=<?php echo $examen['id']; ?>'">afficher</button>
                                <button class="btn btn-primary" onclick="window.location.href='uploadpdf.php?id=<?php echo $examen['id']; ?>'">upload</button>
                    ...
                    <div class="join-icon">
                    <a href="http://localhost/Nourprojet/views/afficherexamform.php">
